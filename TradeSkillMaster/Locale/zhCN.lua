...
L["%d auctions"] = "%d个拍卖"
L["%d groups"] = "%d个分组"
L["%d items were added from the table to %s."] = "已将 %d 个物品从列表添加到 %s。"
L["%d items were added from the table to groups."] = "已将 %d 个物品从列表添加到分组。"
L["%d of %d"] = "%d堆，每堆%d个"
...
L["%s (%s player, %s alts, %s guild, %s warbank, %s AH)"] = "%s (%s 当前角色, %s 小号, %s 公会仓, %s 战网仓, %s 拍卖行)"
L["%s (%s profit)"] = "%s (%s利润)"
...
L["%s sent you %sx%d"] = "%s 邮寄给了你 %sx%d"
L["%s sent you %sx%d and %s"] = "%s 邮寄给了你 %sx%d 和 %s"
L["%s sent you multiple items"] = "%s 邮寄给了你多个物品"
L["%s sent you multiple items and %s"] = "%s 邮寄给了你多个物品及 %s"
L["%s total"] = "共计%s"
...
L["'%s' is an invalid operation. Min restock of %d is higher than max restock of %d for %s."] = "'%1$s' 为无效操作。对于 %4$s，最小补货量 %2$d 高于最大补货量 %3$d。"
L["'%s' is not a valid argument for convert()."] = "'%s' 不是 convert() 的有效参数。"
L["'%s' is not a valid item argument."] = "'%s' 不是有效的物品参数。"
L["'%s' is not a valid source."] = "'%s' 不是有效的数据源。"
...
L["A custom string to define the destroy value TSM references when determining whether to vendor an item based on the threshold defined in 'Max destroy value' field."] = "定义 TSM 参考的分解/拆解价值自定义字符串（用于根据'最大拆解价值'阈值判断是否卖店）。"
L["A custom string to define the market value TSM references when determining whether to vendor an item based on the threshold defined in 'Max market value' field."] = "定义 TSM 参考的市场价值自定义字符串（用于根据'最大市场价值'阈值判断是否卖店）。"
L["A custom string to define the threshold of the 'Destroy value' to consider items for vendoring. Set this to '0c' to disable this condition."] = "定义将物品列入卖店考虑的'拆解价值'阈值自定义字符串。设置为 '0c' 可禁用此条件。"
L["A custom string to define the threshold of the 'Market value' to consider items for vendoring. Set this to '0c' to disable this condition."] = "定义将物品列入卖店考虑的'市场价值'阈值自定义字符串。设置为 '0c' 可禁用此条件。"
L["A custom string which defines how TSM determines the cost of acquiring a material by default. This can be overridden on a per-material basis within the 'Crafting Reports' tab of the Crafting UI."] = "定义 TSM 默认如何计算材料获取成本的自定义字符串。可在制造界面的'制造报告'选项卡中按材料单独重写。"
L["A custom string which defines how TSM determines the value of a crafted item. This can be overridden within a Crafting operation."] = "定义 TSM 如何确定制造物品价值的自定义字符串。可在制造操作中重写。"
...
L["Add Custom Source Column"] = "添加自定义数据源列"
...
L["After an item has expired this many times, it will no longer be posted on the AH. Set this to 0 to disable it."] = "当物品流拍达到此次数后将不再上架拍卖行。设置为 0 可禁用此限制。"
L["Alarm Clock"] = "闹钟"
L["All"] = "所有"
L["All Auctions"] = "所有拍卖"
L["All Bought"] = "全部购买"
...
L["Alt realm historical price"] = "其他服务器历史价格"
L["Alt realm market value"] = "其他服务器市场价值"
L["Alt realm market value and trend"] = "其他服务器市场价值与趋势"
L["Alt realm min buyout"] = "其他服务器最低一口价"
L["Alt realm recent value"] = "其他服务器近期价值"
L["Alternate AuctionDB Realm Data"] = "备用 AuctionDB 服务器数据"
L["Alts"] = "小号"
L["Alts AH"] = "小号AH"
L["Amount"] = "数量"
...
L["Are you sure you want to clear accounting data older than %d days for the current realm?"] = "确定要清除当前服务器早于 %d 天的账务数据吗？"
...
L["AuctionDB - Recent Value"] = "AuctionDB - 近期价值"
L["AuctionDB - Region Historical Price"] = "AuctionDB - 地区历史价格"
L["AuctionDB - Region Market Value Average"] = "AuctionDB - 地区市场均价"
L["AuctionDB - Region Sale Average"] = "AuctionDB - 地区销售均价"
L["AuctionDB - Region Sale Rate"] = "AuctionDB - 地区销售率"
L["AuctionDB - Region Sold Per Day"] = "AuctionDB - 地区日均销量"
L["AuctionDB Realm Data is %s Old"] = "拍卖数据库 服务器数据是%s旧的"
L["AuctionDB Region Data is %s Old"] = "拍卖数据库 区域数据是%s旧的"
L["AuctionDB data alternate realm"] = "AuctionDB 数据备用服务器"
...
L["Automatically show the Destroying UI when you have something in your bags to destroy."] = "背包中有可分解/拆解的物品时自动显示拆解界面。"
L["Automtaically combine smaller stacks of herbs and ore as needed for milling and prospecting respectively."] = "研磨或选矿时自动按需合并草药和矿石的小堆叠。"
